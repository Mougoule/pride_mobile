...
public abstract class PrideAbstractActivity extends ActionBarActivity implements OnSharedPreferenceChangeListener {
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		// Quand on modifie les prefs, on a rien � faire
	}
	 ...
	 *            Url (hors base)
	 * @param clazz
	 *            Classe attendue en r�ponse
	 * @param params
	 *            Param�tres de l'appel (POST)
	 * @param callback
	 *            Foncion � ex�cuter au retour du WS
	 ...
	 *            URL � appeler
	 * @param clazz
	 *            Classe pour le mapping de la r�ponse
	 * @param params
	 *            Param�tres de Web service
	 * @param callback
	 *            Focntion � ex�cuter lors de la r�ponse
	 */
	 ...
	 *            Indique qu'il faut v�rifier les erreurs de licences
	 */
	 ...
	 *            Param�tres de Web service
	 * @param callback
	 *            Fonction � ex�cuter lors de la r�ponse
	 */
	...
	/**
	 * Deconnexion de l'application et redirection � la page de login
	 */
	public void logout() {
		Log.i(TAG, "D�connexion");
	...
	public void logoutAndRedirect() {
		Log.i(TAG, "D�connexion et redirection");
		logout();
	...
	/**
	 * V�rifier si les champs texte sont null. Permet aussi de cacher les champs
	 * vides.
	 * 
	 * @param textview
	 * @param txt
		...
		public void run() {
			try {
				...
				if (!wsResponse.isSuccess() && WSError.TECH.checkCode(errorCode)) {
					...
					// Affichage popup erreur en focntion du code re�u
	...
	/**
	 * V�rifie l'acc�s au r�seau
	 * 
	 * @return Vrai si connect� au r�seau
	 */
	...
	/**
	 * M�thode pour la cr�ation de toast au sein d'un thread (on ne peut pas
	 * cr�er un toast dans un thread, il faut un runOnUiThread
	 * 
	 * @param msg
	 *            Le message � afficher dans le toast
	 * @param context
	...
	/**
	 * M�thode permettant de setter une liste view depuis un thread. Cela devant �tre fait depuis un UIThread
	 * 
	 * @param listView la liste view � setter
	...
	/**
	 * Méthode permettant de setter une liste view depuis un thread. Cela devant �tre fait depuis un UIThread
	 * 
	 * @param listView la liste view � setter
	 * @param adapter l'adapter pour setter la liste view
	 * @param txtListeVide le texte en cas de liste vide
